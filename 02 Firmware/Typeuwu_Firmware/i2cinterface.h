...
#else
#define I2C_BUFFER_SIZE 32    // According to Arduino documentation the software buffer 'Wire' library is 32 bytes.
                              // With the RP2040 the software buffer is set to 256 bytes. May need to limit to 32 bytes if Firmware is compiled for other MCU.
#endif
